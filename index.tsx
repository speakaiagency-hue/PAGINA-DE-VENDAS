  ...
  return (
    <header
      className={`fixed top-0 left-0 right-0 z-[500] transition-all duration-300 overflow-x-hidden ${
        scrolled ? 'bg-black/95 backdrop-blur-2xl py-3' : 'bg-transparent py-6'
      }`}
    >
      <div className="max-w-7xl mx-auto px-6 flex items-center justify-between relative">
        ...
        <div
          className={`lg:hidden fixed inset-0 bg-black z-[10000] flex flex-col items-center justify-center transition-all duration-500 ease-in-out ${
            isMenuOpen
